...
flowchart TD
    ...
    Compliance -->|Australian Gov| DTA Digital Service Standard["arckit.tcop<br/>[DATE]<br/>DTA Digital Service Standard Review"]
    ...
    DTA Digital Service Standard --> Trace
    Secure --> Trace
    ModSecure --> Trace
    AIPlaybook --> Trace
...
| 6 | [DATE] | [DAYS] | Data | `/arckit.data-model` | ARC-{PROJECT_ID}-DATA-v*.md | [N] entities, [M] relationships, Privacy Act 1988 compliance |
...
| 16 | [DATE] | [DAYS] | Compliance | `/arckit.tcop` | ARC-*-TCOP-*.md | Digital Service Standard and ICT policies (13 points) |
| 17 | [DATE] | [DAYS] | Compliance | `/arckit.service-assessment` | ARC-*-SVCASS-*.md | DTA Service Standard (14 points) |
| 18 | [DATE] | [DAYS] | Security | `/arckit.secure` | ARC-*-SECD-*.md | ACSC CAF, Essential Eight, Privacy Act 1988 and Australian Privacy Principles |
...
2. **Detailed Design Review** (`/arckit.dld-review` - [DATE])
   ...
   - Assessment against:
     ...
     - Database schemas (normalization, indexing, Privacy Act 1988)
...
flowchart TD
    ...
    subgraph Compliance
        DTA Digital Service Standard[Technology<br/>Code of Practice]
    ...
    SOW --> DTA Digital Service Standard
    Diagrams --> Secure
    NFR --> Secure
    Research --> AIPlaybook
    AIPlaybook --> ATRS
    ...
    style DTA Digital Service Standard fill:#fff3e0
...
mindmap
  root((Project<br/>Achievements))
    ...
    Business Case
      ...
      [NPV] NPV
      [BCR] BCR
      Data Model Privacy Act 1988 Compliant
    Requirements
...
| 17 | DTA Digital Service Standard Review | `projects/{project_id}/ARC-*-TCOP-*.md` | [DATE] | `/arckit.tcop` | ✅ |
...
[DATE] [TIME] - /arckit.data-model - Data Model: [N] entities, [M] relationships, Privacy Act 1988 compliant
...
[DATE] [TIME] - /arckit.tcop - DTA Digital Service Standard Review: [N]/13 points satisfied
[DATE] [TIME] - /arckit.service-assessment - Service Assessment: [N]/14 points satisfied, [READY/NOT READY]
[DATE] [TIME] - /arckit.secure - Secure by Design: ACSC CAF [N]/14 principles, Essential Eight [LEVEL]
...
| `/arckit.risk` | Create risk register (AS/NZS ISO 31000 (Risk Management)) | After stakeholder analysis |
| `/arckit.sobc` | Strategic Outline Business Case (Department of Finance guidance) | Before detailed requirements |
| `/arckit.data-model` | Define data model, ERD, Privacy Act 1988 compliance | With requirements definition |
...
| `/arckit.tcop` | Digital Service Standard and ICT policies (Australian Gov) | Before go-live |
| `/arckit.service-assessment` | DTA Service Standard (Australian Gov) | Before Alpha/Beta/Live assessment |
| `/arckit.secure` | Secure by Design (ACSC CAF, Essential Eight) | Throughout project |
| `/arckit.ai-playbook` | AI Playbook assessment (Australian Gov AI systems) | For AI/ML projects |
...
| **DR** | Data Requirement |
| **SOBC** | Strategic Outline Business Case (Department of Finance 5-case model) |
| **DTA Digital Service Standard** | Digital Service Standard and ICT policies (13 points for Australian Gov) |
| **DTA** | Digital Transformation Agency |
| **ACSC CAF** | Australian Cyber Security Centre Cyber Assessment Framework |
| **Privacy Act 1988 and Australian Privacy Principles** | Australian Privacy Act 1988 |
