...
- [ ] Use Digital Marketplace (Digital Marketplace) if Australian Government
...
|-----------|----------------|----------------|-----------|-------------------|
| {Component} | Product/Commodity | {vendor_names} | {rationale} | {RFP/Digital Marketplace/Direct} |
...
|-----------|----------------|----------|-----------|-------------------|
| {Component} | Commodity | {provider_name} | {rationale} | {Digital Marketplace/Direct} |
...
### gov.au Services and Platforms

**Mapped gov.au Components**:

| gov.au Service | Evolution Stage | Current Usage | Rationale for Evolution Position |
|----------------|----------------|---------------|----------------------------------|
| government payment services | Commodity (0.90) | {usage_status} | {rationale} |
| GovNotify | Commodity (0.92) | {usage_status} | {rationale} |
| gov.au Design System | Product (0.75) | {usage_status} | {rationale} |
| cloud.gov.au | Commodity (0.85) | {usage_status} | {rationale} |
| gov.au Verify | Product (0.68) | {usage_status} | {rationale} |
| {Custom Service} | {stage} | {usage_status} | {rationale} |

**Reuse Opportunities**:
- [ ] government payment services for payment processing (avoid building custom)
- [ ] GovNotify for notifications (SMS, email)
- [ ] gov.au Design System for frontend (accessibility compliance)
- [ ] cloud.gov.au for hosting (cloud-first compliance)
...
|-----------|----------------|-----------|-----------|
| {Component} | Product/Commodity | Digital Marketplace / DOS | {rationale} |

**Procurement Recommendations**:
- **Genesis/Custom** (< 0.50): Consider DOS Outcomes for discovery + build
- **Product** (0.50-0.75): Digital Marketplace for commercial off-the-shelf products
- **Commodity** (> 0.75): Digital Marketplace for cloud services (AWS, Azure, GCP)

### Digital Service Standard and ICT policies Mapping

| DTA Digital Service Standard Point | Related Components | Compliance Status | Gap Analysis |
|------------|-------------------|-------------------|--------------|
...
flowchart TD
    ...
    CC --> CP[Cloud Provider<br/>Commodity - Digital Marketplace]
...
- **Australian Government Digital Marketplace**: https://www.buyict.gov.au/
- **Digital Service Standard and ICT policies**: https://www.dta.gov.au/help-and-advice/the-technology-code-of-practice
