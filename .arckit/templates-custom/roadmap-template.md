...
### Investment Summary
- **Total Investment**: $AUD [AMOUNT] over [N] years
- **Capital Expenditure**: $AUD [CAPEX]
- **Operational Expenditure**: $AUD [OPEX]
...
- **Total Technical Debt**: $AUD [AMOUNT] or [N] person-months
...
- Initiative 3.2: Implement ACSC CAF baseline controls
...
| Financial Year | Capital ($AUD ) | Operational ($AUD ) | Total ($AUD ) | % of Total Budget |
|----------------|-------------|-----------------|-----------|-------------------|
| FY [YEAR] | $AUD [CAPEX] | $AUD [OPEX] | $AUD [TOTAL] | [%] |
| FY [YEAR+1] | $AUD [CAPEX] | $AUD [OPEX] | $AUD [TOTAL] | [%] |
| FY [YEAR+2] | $AUD [CAPEX] | $AUD [OPEX] | $AUD [TOTAL] | [%] |
| FY [YEAR+3] | $AUD [CAPEX] | $AUD [OPEX] | $AUD [TOTAL] | [%] |
| **Total** | **$AUD [CAPEX]** | **$AUD [OPEX]** | **$AUD [TOTAL]** | **100%** |

### Resource Requirements

| Financial Year | FTE Required | Key Roles | Recruitment Timeline | Training Budget |
|----------------|--------------|-----------|---------------------|-----------------|
| FY [YEAR] | [N] | Cloud architects, Security specialists | Q1-Q2 | $AUD [AMOUNT] |
| FY [YEAR+1] | [N] | Developers, Data engineers, DevOps | Q3-Q4 | $AUD [AMOUNT] |
| FY [YEAR+2] | [N] | SRE, Platform engineers, Data scientists | Q1-Q2 | $AUD [AMOUNT] |
| FY [YEAR+3] | [N] | Optimization specialists, Automation engineers | Q3 | $AUD [AMOUNT] |

### Investment by Theme

| Theme | FY [YEAR] | FY [YEAR+1] | FY [YEAR+2] | FY [YEAR+3] | Total |
|-------|-----------|-------------|-------------|-------------|-------|
| Theme 1 | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [TOTAL] |
| Theme 2 | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [TOTAL] |
| Theme 3 | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [TOTAL] |

### Cost Savings & Benefits Realization

| Benefit Type | FY [YEAR] | FY [YEAR+1] | FY [YEAR+2] | FY [YEAR+3] | Cumulative |
|--------------|-----------|-------------|-------------|-------------|------------|
| Operational Savings | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [TOTAL] |
| Efficiency Gains | [%] | [%] | [%] | [%] | [%] |
| Revenue Enablement | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [TOTAL] |
...
|-----------------|-------------|-------------------|
| **Budget** | Total budget capped at $AUD [AMOUNT] | Prioritization required |
| **Timeline** | Must achieve [milestone] by [DATE] | Parallel workstreams needed |
| **Regulatory** | Must maintain Privacy Act 1988 compliance throughout migration | Data migration approach constrained |
...
| Revenue enablement | $AUD 0 | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [AMOUNT] |
...
| ACSC CAF | Baseline only | Full baseline | Enhanced | Advanced | Advanced |
| Privacy Act 1988 and Australian Privacy Principles | Compliant | Compliant | Enhanced | Optimized | Optimized |
