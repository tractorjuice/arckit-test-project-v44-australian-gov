...
- **Regulatory context**: [Privacy Act 1988, DTA Service Standard, Essential Eight, etc.]
...
- **DTA Service Standard**: [Which points apply? Point 4: Open standards, Point 9: Hosting, etc.]
- **Digital Service Standard and ICT policies**: [Which points? Point 5: Cloud first, Point 8: Reuse, Point 13: AI]
- **ACSC Cyber Security**: [Essential Eight Maturity Level 3, CAF principles]
- **Data Protection**: [Privacy Act 1988 and Australian Privacy Principles: Privacy by design (APP 1), Security (APP 11), PIA where required]
...
#### DTA Service Standard Impact
| Point | Impact | Notes |
|-------|--------|-------|
| 4. Open standards | [Positive/Negative/Neutral] | [Explanation] |
| 5. Security | [Impact] | [ACSC guidance compliance] |
...
> to achieve Australian data residency and ACSC-assured cloud hosting,
...
**DTA Service Assessment**:
- [ ] Point [X]: [How this decision addresses Service Standard point]
- [ ] Evidence prepared for assessment

**Digital Service Standard and ICT policies**:
- [ ] Point [X]: [How this decision addresses DTA Digital Service Standard point]

**Security assurance**:
- [ ] ACSC Cloud Security Principles: [Which principles apply?]
...
- *Australian Gov ADR Framework: https://www.gov.au/government/publications/architectural-decision-record-framework*
