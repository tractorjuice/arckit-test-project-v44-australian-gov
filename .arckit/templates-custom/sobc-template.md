...
**Investment Required**: $AUD [X]M over [Y] years
- Capital: $AUD [X]M
- Operational (3 years): $AUD [X]M

**Expected Benefits**: $AUD [X]M over [Y] years
- [Top 3 benefits with values]

**Return on Investment**:
- NPV: $AUD [X]M (discounted at 7% real, per Department of Finance guidance)
...
|-------------|-----------|------------|--------|-----------|
| [CFO] | D-001 | [High infrastructure costs] | [$AUD 2M annual overspend] | CRITICAL |
...
- [Manifesto Commitment (Australian Gov)]: [How this delivers it]
...
|---------|-------------|------------|---------------|--------------|----------|
| G-001 | CFO | Reduce infrastructure costs 40% by Q4 2025 | $AUD 5M/year | $AUD 3M/year | 18 months |
...
- [Cost 1: $AUD X per month in continued overspend]
- [Cost 2: Lost revenue opportunity: $AUD Y]
...
**Costs** (3-year):
- Capital: $AUD 0
- Operational: $AUD [X]M (continued high running costs)
- Total: $AUD [X]M

**Benefits**: $AUD 0 (no improvement)
...
**Risks**:
- [Risk 1]: Compliance failure → $AUD [X]M fine + reputational damage
- [Risk 2]: System failure → $AUD [X] per hour downtime
- [Risk 3]: Staff attrition → Recruitment costs $AUD [X]
...
- Capital: $AUD [X]M
  - [Item 1]: $AUD [X]
  - [Item 2]: $AUD [X]
- Operational: $AUD [X]M over 3 years
  - [Item 1]: $AUD [X]/year
- Total 3-year TCO: $AUD [X]M

**Benefits** (3-year):
- **B-001** (from CFO Goal G-001): Cost reduction $AUD [X]M
- **B-002** (from CTO Goal G-002): Efficiency gain $AUD [X]M
- Total: $AUD [X]M

**Net Benefit**: $AUD [X]M (Benefits - Costs)
...
**Costs** (3-year) - ROM (±30%):
- Capital: $AUD [X]M
  - [Infrastructure]: $AUD [X]
  - [Software licenses]: $AUD [X]
  - [Implementation services]: $AUD [X]
  - [Training]: $AUD [X]
- Operational: $AUD [X]M over 3 years
  - [Managed services]: $AUD [X]/year
  - [Support & maintenance]: $AUD [X]/year
  - [Staff costs (reduced)]: $AUD [X]/year
- Total 3-year TCO: $AUD [X]M
...
|------------|---------------------|------------------|------|--------|--------|--------|--------------|
| B-001 | Infrastructure cost reduction | CFO G-001 | FINANCIAL | $AUD 0.5M | $AUD 2M | $AUD 2M | $AUD 4.5M |
| B-002 | Productivity gain (automation) | Operations G-003 | OPERATIONAL | $AUD 0.3M | $AUD 1M | $AUD 1M | $AUD 2.3M |
| B-003 | Revenue from faster time-to-market | CTO G-002 | STRATEGIC | $AUD 0.2M | $AUD 0.8M | $AUD 1.5M | $AUD 2.5M |
| B-004 | Compliance risk reduction | CISO G-004 | RISK | $AUD 0.1M | $AUD 0.5M | $AUD 0.5M | $AUD 1.1M |
| **Total Benefits** | | | | **$AUD 1.1M** | **$AUD 4.3M** | **$AUD 5M** | **$AUD 10.4M** |

**Net Present Value** (3.5% discount rate):
- Total Benefits PV: $AUD [X]M
- Total Costs PV: $AUD [X]M
- **NPV: $AUD [X]M** (positive = good investment)
...
**Costs** (3-year) - ROM (±40%):
- Capital: $AUD [X]M (significantly higher)
- Operational: $AUD [X]M over 3 years
- Total 3-year TCO: $AUD [X]M

**Benefits** (3-year): $AUD [X]M (marginally higher than Option 2)

**Net Benefit**: $AUD [X]M (lower than Option 2 due to diminishing returns)
...
**Cons**:
- ❌ High cost ($AUD [X]M more than Option 2)
...
**Rationale**:
1. **Best Value**: Highest NPV at $AUD [X]M
...
- If costs increase 20%: NPV still positive ($AUD [X]M)
...
- Adjusted Total Cost: $AUD [X]M → $AUD [X]M (with uplift)
- NPV with optimism bias: Still positive at $AUD [X]M
...
**Australian Digital Marketplace Assessment** (if applicable):
- **Digital Marketplace**: [X] suppliers offering [capability]
- **Digital Marketplace Outcomes/Specialists**: [Y] suppliers for outcomes/specialists
- **SME participation**: [Z]% of suppliers are SMEs

### C1.2 Sourcing Route

**Recommended Route**:
- **Australian Government**: Digital Marketplace - [Digital Marketplace | DOS Outcomes | DOS Specialists]
...
- Penalties: [$AUD X] per hour downtime beyond SLA
...
**Total Investment Required**: $AUD [X]M over [Y] years

### D1.1 Capital Expenditure (CapEx)

| Item | Year 1 | Year 2 | Year 3 | Total |
|------|--------|--------|--------|-------|
| Infrastructure (servers, cloud setup) | $AUD [X] | $AUD [X] | $AUD 0 | $AUD [X]M |
| Software licenses (perpetual/3-year) | $AUD [X] | $AUD 0 | $AUD 0 | $AUD [X]M |
| Implementation services (vendor) | $AUD [X] | $AUD [X] | $AUD 0 | $AUD [X]M |
| Internal project costs (staff time) | $AUD [X] | $AUD [X] | $AUD 0 | $AUD [X]M |
| Contingency (15%) | $AUD [X] | $AUD [X] | $AUD 0 | $AUD [X]M |
| **Total CapEx** | **$AUD [X]M** | **$AUD [X]M** | **$AUD 0** | **$AUD [X]M** |

### D1.2 Operational Expenditure (OpEx)

| Item | Year 1 | Year 2 | Year 3 | 3-Year Total |
|------|--------|--------|--------|--------------|
| Managed services (cloud, support) | $AUD [X] | $AUD [X] | $AUD [X] | $AUD [X]M |
| Software subscriptions (SaaS) | $AUD [X] | $AUD [X] | $AUD [X] | $AUD [X]M |
| Support & maintenance (vendor) | $AUD [X] | $AUD [X] | $AUD [X] | $AUD [X]M |
| Internal staff costs (reduced headcount) | $AUD [X] | $AUD [X] | $AUD [X] | $AUD [X]M |
| Training & change management | $AUD [X] | $AUD [X] | $AUD 0 | $AUD [X]M |
| **Total OpEx** | **$AUD [X]M** | **$AUD [X]M** | **$AUD [X]M** | **$AUD [X]M** |

### D1.3 Total Cost of Ownership (TCO)

| | Year 1 | Year 2 | Year 3 | 3-Year Total |
|---|--------|--------|--------|--------------|
| CapEx | $AUD [X]M | $AUD [X]M | $AUD 0 | $AUD [X]M |
| OpEx | $AUD [X]M | $AUD [X]M | $AUD [X]M | $AUD [X]M |
| **Total TCO** | **$AUD [X]M** | **$AUD [X]M** | **$AUD [X]M** | **$AUD [X]M** |

**Notes**:
- All costs in [current year] prices
- Excludes GST (if applicable)
- Optimism bias NOT YET applied (add 40% for Australian Gov)

## D2. Funding Source

**Budget Allocation**:
- **Source**: [IT Capital Budget | Digital Transformation Fund | Spending Review settlement]
- **Amount Available**: $AUD [X]M
- **Timing**: [Financial years when available]

**Budget Approval Path**:
1. [Departmental board]: Up to $AUD [X]M
2. [Finance committee]: $AUD [X]M to $AUD [Y]M
3. [Department of Finance]: Above $AUD [Y]M (Australian Government)

**Funding Gaps** (if any):
- Gap: $AUD [X]M in Year [Y]
- **Mitigation**: [Defer non-critical components | Seek additional funds | Phase differently]

## D3. Affordability

**Organizational Budget Context**:
- Total IT budget: $AUD [X]M/year
- This project: [X]% of IT budget
- Assessment: **Affordable** | **Marginal** | **Not Affordable**

**Cash Flow Impact**:
- Largest single payment: $AUD [X]M in [Month/Year]
- **Cashflow Risk**: [Assessment]
- **Mitigation**: [Payment staging, reserve usage]

**Ongoing Affordability**:
- Year 3+ OpEx: $AUD [X]M/year
- Funded by: [Savings from decommissioned systems: $AUD [X]M + Budget increase: $AUD [X]M]

## D4. Financial Appraisal

### D4.1 Economic Appraisal (Department of Finance Business Case Guidance)

**Discount Rate**: 7% real (Department of Finance standard discount rate for public investment)

**Net Present Value Calculation**:

| Year | Costs | Benefits | Net Cashflow | Discount Factor | Present Value |
|------|-------|----------|--------------|-----------------|---------------|
| 0 | $AUD [X]M | $AUD 0 | -$AUD [X]M | 1.000 | -$AUD [X]M |
| 1 | $AUD [X]M | $AUD [X]M | -$AUD [X]M | 0.966 | -$AUD [X]M |
| 2 | $AUD [X]M | $AUD [X]M | +$AUD [X]M | 0.934 | +$AUD [X]M |
| 3 | $AUD [X]M | $AUD [X]M | +$AUD [X]M | 0.902 | +$AUD [X]M |
| **Total** | **$AUD [X]M** | **$AUD [X]M** | **+$AUD [X]M** | | **$AUD [X]M (NPV)** |

**NPV Result**: $AUD [X]M (positive = good investment)
...
ROI = ($AUD [X]M - $AUD [X]M) / $AUD [X]M × 100% = [X]%
```
...
| Budget approval | Finance Director | SRO | Secretary (Australian Gov) | Department of Finance |
...
**Training Plan**:
- [Training 1]: For [X] people, $AUD [Y], [Timeline]
- [Training 2]: For [X] people, $AUD [Y], [Timeline]
...
**Training Costs**: Included in OpEx ($AUD [X] Year 1)
...
- **Owner**: CFO
- **Baseline**: $AUD 5M/year (current state)
- **Target**: $AUD 3M/year (40% reduction)
- **Measurement**: Monthly cloud spend reports vs baseline
- **Timeline**: 
  - Month 6 post-live: 20% reduction ($AUD 4M/year)
  - Month 12 post-live: 40% reduction ($AUD 3M/year)
...
- **Value Assumption**: Each additional feature = $AUD 10K revenue/month
- **Timeline**:
  - Month 3 post-live: 3x deployment frequency = $AUD 200K revenue
  - Month 12 post-live: 10x deployment frequency = $AUD 800K revenue
- **Status**: Not yet realized (pre-project)
...
|---------|------------------|-------------------|------------|--------|-------|------------|-------|
| R-001 | Funding not secured | All stakeholders (project cancelled) | Medium | Critical | 12 | Early Department of Finance engagement, phased spend | SRO |
...
| R-007 | Cyber security incident during migration | Data breach, reputational damage | Low | Critical | 9 | ACSC consultation, penetration testing | CISO |
...
- **Reputational Risk**: Low (Australian Gov cannot afford public failure)
...
**Investment**: $AUD [X]M over 3 years

**Expected Return**: $AUD [X]M over 3 years (NPV: $AUD [X]M, ROI: [X]%)
...
1. Funding secured: $AUD [X]M confirmed available
2. SRO appointed and accepted role
3. Steering Committee established
4. Department of Finance approval (if threshold exceeded) - Australian Gov
...
1. **Funding Approval**: Finance Director secures $AUD [X]M allocation - **Target: [Date]**
...
2. **Digital Marketplace**: Publish opportunity on Digital Marketplace (Australian Gov) - **Target: [Date]**
...
- Stakeholder goals not met (0%)
- Continued overspend: $AUD [X]M over 3 years
- Compliance risk increases
- Competitive disadvantage worsens
...
*Department of Finance Business Case compliant: Yes (5-case model)*
