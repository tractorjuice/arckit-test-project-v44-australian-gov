...
### Compliance Summary
- **Privacy Act 1988 Status**: [COMPLIANT | NEEDS_PIA | GAPS_IDENTIFIED]
...
- **Privacy Officer**: [Name/Role] - Ensures privacy compliance
...
- **Total Retention**: [Z] years (driven by [Privacy Act 1988 | tax law | regulatory requirement])
...
**Privacy Act 1988 / APP Considerations**:
- **Contains Personal Information**: [YES | NO]
- **Personal Information Attributes**: [List of columns: email, first_name, last_name, phone, etc.]
- **Collection Basis (APP 3)**: [Reasonably necessary for functions/activities | Required by law | Consent (for sensitive information)]
- **Individual Rights**:
  - **Right to Access (APP 12)**: Provide [entity] records via API endpoint [/api/access-request]
  - **Right to Correction (APP 13)**: Allow updates via [admin portal | API endpoint]
  - **De-identification (APP 11.2)**: [De-identify | Delete] records when no longer needed
  - **Right to Anonymity (APP 2)**: [Support anonymous access where practicable | Not applicable]
  - **Direct Marketing Opt-out (APP 7)**: [Support opt-out | Not applicable]
- **Data Breach Impact**: [HIGH | MEDIUM | LOW] - If this entity is breached, impact on individuals
- **Cross-Border Disclosure (APP 8)**: [None | APAC | US | Other] - Where data may be disclosed
- **Privacy Impact Assessment (PIA)**: [REQUIRED | NOT_REQUIRED]
...
- **APRA/ASIC Regulations**: [Applicable if financial services] - Australian financial conduct rules
...
#### Privacy & Compliance
[Privacy Act 1988 considerations, PII handling, Data subject rights, Compliance requirements]
...
|--------|----------------|--------------|---------------------|-------------|------------|-------------|----------------|
| E-001: [Entity] | [CFO] | [Data Governance Lead] | [Database Team] | CONFIDENTIAL | Privacy Act 1988, PCI-DSS | 99% accuracy | Role: Admin, Finance |
| E-002: [Entity] | [CTO] | [Data Governance Lead] | [Database Team] | INTERNAL | None | 95% completeness | Role: All authenticated |
| E-003: [Entity] | [CMO] | [Marketing Data Lead] | [Database Team] | CONFIDENTIAL | Privacy Act 1988, Marketing regs | 98% accuracy | Role: Marketing, Sales |
...
**Sensitive Information** (as defined in Privacy Act 1988 s6):
- [None | Health data | Biometric data | etc.] in entity [E-XXX]
- Requires consent under APP 3.3 or applicable exception

#### Legal Basis for Processing

| Entity | Purpose | APP Basis | Notes |
|--------|---------|-------------|-------|
| E-001: Customer | Customer account management | APP 3 — Reasonably necessary for functions | Collection necessary for service delivery |
| E-002: Transaction | Payment processing | APP 3 — Reasonably necessary for functions | Financial transaction execution |
| E-003: PaymentMethod | Payment processing | APP 3 + APP 3.3 (if sensitive) | Store for future transactions with consent |
| E-004: RefundRequest | Refund processing | APP 3 — Reasonably necessary for functions | Customer service obligation |
...
**Right to Access (APP 12 — Access to personal information)**:
- **Endpoint**: [/api/v1/access-request]
- **Authentication**: Multi-factor authentication required
- **Response Format**: JSON containing all personal information
- **Response Time**: Within 30 days (OAIC guidance)
- **Entities Included**: E-001, E-002, E-003, E-004 (all entities with personal information)
...
**De-identification / Deletion (APP 11.2)**:
- **Method**: [Hard delete | De-identification | Anonymization]
- **Process**:
  1. Customer submits deletion request via [account settings | support ticket]
  2. Privacy Officer reviews request (legal obligations check)
  3. If approved, [delete | de-identify] personal information within 30 days
  4. Notify downstream systems to delete/de-identify
- **Exceptions**: Cannot delete if legal obligation to retain (e.g., financial records for tax law)
- **Retention Override**: Transaction financial data retained for 7 years per tax law (personal information de-identified)

**Direct Marketing Opt-out (APP 7)**:
- **Endpoint**: [/api/v1/marketing-preferences]
- **Marketing Opt-out**: E-001.marketing_consent = false
- **Opt-out must be facilitated at no cost**

**Anonymity / Pseudonymity (APP 2)**:
- **Where practicable**: Allow individuals to interact without identifying themselves
- **Flag**: E-001.anonymous_access = [true/false]

#### Data Retention Schedule

| Entity | Active Retention | Archive Retention | Total Retention | Legal Basis | Deletion Method |
|--------|------------------|-------------------|-----------------|-------------|-----------------|
| E-001: Customer | Active account + 2 years | 5 years | 7 years | Tax law, Privacy Act 1988 | Anonymize PII, retain transactions |
| E-002: Transaction | 3 years | 4 years | 7 years | Tax law (ATO) | Hard delete after 7 years |
| E-003: PaymentMethod | Active account | N/A | Until deleted by user | Privacy Act 1988 | Hard delete on user request |
...
**Data Locations**:
- **Primary Database**: [Australia | APAC | US] - [Cloud provider, region]
- **Backup Storage**: [Australia | APAC | US] - [Cloud provider, region]
- **Downstream Systems**: [List countries where data is transferred]

**Australia-APAC Data Transfers**:
- **Adequacy Decision**: Australia bilateral data sharing agreement in effect (no additional safeguards required as of 2025)
- **Standard Contractual Clauses (SCCs)**: [Required | Not required]

**Australia-US Data Transfers**:
- **Australia-US bilateral data arrangement**: [Applicable | Not applicable]
...
**Triggers for PIA** (OAIC PIA Guide):
- ✅ Large-scale processing of sensitive information (health, biometric, etc.)
...
- **OAIC Consultation Required**: [YES | NO] - If high residual risk, consult OAIC

#### Notifiable Data Breaches (NDB) Scheme

**Data Breach Notification** (Part IIIC, Privacy Act 1988):
- **Breach Detection**: Automated monitoring, security alerts
- **Assessment**: Within 30 days of becoming aware of suspected eligible data breach
- **OAIC Notification**: As soon as practicable if eligible data breach (likely to result in serious harm)
...
#### APRA/ASIC Regulations (Australian Financial Regulation)
...
| currency | ISO 4217 | "DOLLARS" | Reject on insert, must be "USD", "AUD", etc. |
...
| DR-006 | Privacy Act 1988: Right to erasure | E-001: Customer | [All PII fields] | ✅ Implemented | Anonymization process defined |
...
- **Justification**: [Strong ACID guarantees for financial transactions, excellent JSON support for flexible attributes, mature ecosystem, Privacy Act 1988 compliance tooling]
...
- **Privacy Act 1988**: Australian federal privacy legislation establishing the 13 Australian Privacy Principles (APPs)
- **APPs**: 13 Australian Privacy Principles governing handling of personal information
...
- [Department of Finance business case guidance](https://www.gov.au/government/publications/the-green-book-appraisal-and-evaluation-in-central-governent) - Business case guidance (may reference data costs)
- [OAIC Data Protection](https://oaic.gov.au/for-organisations/guide-to-data-protection/) - Privacy Act 1988 and Australian Privacy Principles compliance guidance
- [PCI Security Standards](https://www.pcisecuritystandards.org/) - Payment card data security
- [ACSC Cloud Security Principles](https://www.cyber.gov.au/collection/cloud/the-cloud-security-principles) - Australian government cloud security
- [DTA Data Standards](https://www.gov.au/government/collections/data-standards-for-government) - Australian government data standards
