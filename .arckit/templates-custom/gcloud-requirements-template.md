# Australian Digital Marketplace: Digital Marketplace Service Procurement
...
| **Document Type** | Digital Marketplace Service Requirements |
...
|----|-------------|---------------|
| NFR-C-xxx | [From NFR-C-xxx] | [e.g., ISO 27001, Essential Eight Maturity Level 3] |
| NFR-C-xxx | [Data Residency] | [e.g., Australian data centers only, Privacy Act 1988 compliance] |
...
| Criterion | Weight | Description |
|-----------|--------|-------------|
| Security Certifications | 5% | ISO 27001, Essential Eight Maturity Level 3, etc. |
| Data Protection | 5% | Privacy Act 1988 compliance, data residency |
...
- Filters: [Australian data centers, certifications, etc.]

**Digital Marketplace URL**: https://www.buyict.gov.au/g-cloud/search
...
| **Service ID** | [Digital Marketplace Service ID] |
...
11. **Publish on AusTender**: Legal requirement for transparency
...
- **Digital Marketplace**: https://www.buyict.gov.au/
- **Digital Marketplace Buyers Guide**: https://www.dta.gov.au/help-and-advice/g-cloud-buyers-guide
- **General Buying Guide**: https://www.dta.gov.au/help-and-advice/buying-and-selling-on-the-digital-marketplace
- **AusTender**: https://www.gov.au/contracts-finder
...
- Data location: [Australia only / APAC / etc.]
...
| Term | Definition |
|------|------------|
| Digital Marketplace | Australian Government framework for procuring cloud services |
| DOS | Digital Marketplace framework for custom development |
