...
### Digital Service Standard and ICT policies (DTA Digital Service Standard)

| DTA Digital Service Standard Point | Status | Evidence | Gaps |
|------------|--------|----------|------|
| 1. Define user needs | [✅/⚠️/❌] | [Evidence] | [Gaps] |
| 2. Make things accessible | [✅/⚠️/❌] | [Evidence] | [Gaps] |
| [Continue for all 13 points...] | | | |

**DTA Digital Service Standard Score**: [X]/130 ([percentage]%)
...
| DR-ID | Entity | Covered in Model? | Privacy Act 1988 Basis | Issues |
|-------|--------|-------------------|------------|--------|
...
**Severity**: 🔴 CRITICAL
**Category**: [Requirements Quality / Principles Alignment / Traceability / Australian Gov Compliance / etc.]
...
| DTA Digital Service Standard Assessment | `projects/[project]/ARC-*-TCOP-*.md` | [Date] | [✅ Analyzed / ❌ Not Found] |
