...
|---------------------|---------------------------|------|------------------|
| [Category 1] | [Azure Service] | [Standard/Premium] | $AUD [X] |
| [Category 2] | [Azure Service] | [Standard/Premium] | $AUD [Y] |
| [Category 3] | [Azure Service] | [Standard/Premium] | $AUD [Z] |
...
|----------|--------|-------|
| **Australian Region Availability** | ✅ Australia East, Australia Southeast | Primary: Australia East |
...
|------|--------------|----------|----------|
| Basic | $AUD [X] | [Features] | Dev/Test |
| Standard | $AUD [Y] | [Features] | Production |
| Premium | $AUD [Z] | [Features] | Enterprise |

**Estimated Cost for This Project**:

| Resource | Configuration | Monthly Cost | Notes |
|----------|---------------|--------------|-------|
| [Service] | [Size/Tier] | $AUD [X] | [Based on requirements] |
| [Service] | [Size/Tier] | $AUD [Y] | [Based on requirements] |
| **Total** | | **$AUD [Z]** | |
...
| **Essential Eight Maturity Level 3** | ✅ Certified | Azure controls map to CE+ |
...
| Year 2 | $AUD [X] | $AUD [Y] | $AUD [Z] | + 3% reserved savings |
| Year 3 | $AUD [X] | $AUD [Y] | $AUD [W] | + 3% reserved savings |
| **Total** | | | **$AUD [TOTAL]** | |
...
**Azure on Digital Marketplace 14**:
- **Framework**: RM1557.14
...
- **Azure Government Australia**: Separate sovereign cloud
- **Accreditation**: IL3+ certified
- **Access**: Requires MOD/government sponsorship
- **Contact**: [Azure Government Australia team]

### Data Residency

| Data Type | Storage Location | Replication | Notes |
|-----------|------------------|-------------|-------|
| Primary Data | Australia East | Australia Southeast (GRS) | Privacy Act 1988 compliant |
