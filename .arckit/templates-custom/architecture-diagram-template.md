...
- **REUSE**: gov.au services (if Australian Government project)
...
### PII Handling (Privacy Act 1988 and Australian Privacy Principles / Privacy Act 1988 Compliance)
...
| DTA Digital Service Standard Point | Compliance | Component(s) | Evidence |
|------------|------------|--------------|----------|
...
| gov.au Service | Used | Component | Rationale |
|----------------|------|-----------|-----------|
| government payment services | {Yes/No} | {component} | {rationale} |
| GovNotify | {Yes/No} | {component} | {rationale} |
| gov.au Design System | {Yes/No} | {component} | {rationale} |
| gov.au Verify | {Yes/No} | {component} | {rationale} |
| cloud.gov.au | {Yes/No} | {component} | {rationale} |
...
**HLD**: `{path_to_hld}`
**DLD**: `{path_to_dld}`
**DTA Digital Service Standard Assessment**: `{path_to_tcop}`
