...
|---------------------|-------------------------|------|------------------|
| [Category 1] | [AWS Service] | [On-Demand/Reserved] | $AUD [X] |
| [Category 2] | [AWS Service] | [On-Demand/Reserved] | $AUD [Y] |
| [Category 3] | [AWS Service] | [On-Demand/Reserved] | $AUD [Z] |
...
|----------|--------|-------|
| **Australian Region Availability** | ✅ ap-southeast-2 (Sydney) | Primary Australian region |
...
| Reserved (1yr) | $AUD [Y]/hr | 1 year | ~30% |
| Reserved (3yr) | $AUD [Z]/hr | 3 years | ~50% |
| Savings Plans | $AUD [W]/hr | Flexible | ~30% |
...
- ✅ ap-southeast-4 (Ireland) - DR option
...
| **Essential Eight Maturity Level 3** | ✅ Certified | AWS controls map to CE+ |
...
| **SECRET** | ⚠️ AWS GovCloud | US-only, not available in Australia |
...
| Year 2 | $AUD [X] | $AUD [Y] | $AUD [Z] | + Reserved Instance savings |
| Year 3 | $AUD [X] | $AUD [Y] | $AUD [W] | + Reserved Instance savings |
| **Total** | | | **$AUD [TOTAL]** | |
...
- **Note**: Not available in Australia - consider alternative approaches
...
|-----------|------------------|-------------|-------|
| Primary Data | ap-southeast-2 (Sydney) | Cross-AZ | Privacy Act 1988 compliant |
| Backups | ap-southeast-2 | Cross-AZ or S3 Cross-Region to ap-southeast-2 (Melbourne) | Within Australia |
