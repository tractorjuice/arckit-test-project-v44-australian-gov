...
**Research Approach**: [Market research, vendor evaluation, Australian Government Digital Marketplace search, open source assessment]
...
|----------|-----------|------------------|-----------|
| **BUILD** (Custom Development) | [X] categories | $AUD [X] | [Key reason] |
| **BUY** (Commercial SaaS) | [Y] categories | $AUD [Y] | [Key reason] |
| **ADOPT** (Open Source) | [Z] categories | $AUD [Z] | [Key reason] |
| **gov.au Platforms** (if applicable) | [W] categories | $AUD [W] | [Key reason] |
| **TOTAL** | [Total] categories | **$AUD [TOTAL]** | Blended approach |
...
|-----------|--------|--------|--------|-------|
| Development | $AUD [X] | $AUD 0 | $AUD 0 | [Rate] × [person-months] |
| Infrastructure | $AUD [Y] | $AUD [Y] | $AUD [Y] | Cloud hosting |
| Maintenance (30% of dev) | $AUD [Z] | $AUD [Z] | $AUD [Z] | Bug fixes, updates |
| **Total** | **$AUD [T1]** | **$AUD [T2]** | **$AUD [T3]** | |
| **3-Year TCO** | | | **$AUD [TOTAL]** | |
...
| Cost Item | Year 1 | Year 2 | Year 3 | Notes |
|-----------|--------|--------|--------|-------|
| Setup/onboarding | $AUD [X] | $AUD 0 | $AUD 0 | One-time |
| Subscription | $AUD [Y] | $AUD [Y] × 1.1 | $AUD [Y] × 1.2 | [Tier], 10% annual increase |
| Integration | $AUD [Z] | $AUD 0 | $AUD 0 | [X] person-weeks |
| Training | $AUD [W] | $AUD 0 | $AUD 0 | User training |
| **Total** | **$AUD [T1]** | **$AUD [T2]** | **$AUD [T3]** | |
| **3-Year TCO** | | | **$AUD [TOTAL]** | |

**Pricing Tiers**:
- **Starter**: $AUD [X]/month - [Features, limits]
- **Professional**: $AUD [Y]/month - [Features, limits]
- **Enterprise**: $AUD [Z]/month - [Features, limits, SLA]
...
| Cost Item | Year 1 | Year 2 | Year 3 | Notes |
|-----------|--------|--------|--------|-------|
| Infrastructure | $AUD [X] | $AUD [X] | $AUD [X] | Cloud hosting (EC2, RDS, etc.) |
| Setup | $AUD [Y] | $AUD 0 | $AUD 0 | [X] person-weeks |
| Maintenance | $AUD [Z] | $AUD [Z] | $AUD [Z] | [Y] person-weeks/year for updates, patches |
| Commercial Support (optional) | $AUD [W] | $AUD [W] | $AUD [W] | If purchasing support |
| **Total** | **$AUD [T1]** | **$AUD [T2]** | **$AUD [T3]** | |
| **3-Year TCO** | | | **$AUD [TOTAL]** | |
...
| Cost Item | Year 1 | Year 2 | Year 3 | Notes |
|-----------|--------|--------|--------|-------|
| Managed Service Subscription | $AUD [X] | $AUD [X] | $AUD [X] | [Provider] managed hosting |
| Setup/Integration | $AUD [Y] | $AUD 0 | $AUD 0 | [X] person-weeks |
| **Total** | **$AUD [T1]** | **$AUD [T2]** | **$AUD [T3]** | |
| **3-Year TCO** | | | **$AUD [TOTAL]** | |
...
### Option 1E: gov.au Platform - [PLATFORM_NAME] (Australian Government Only)

> **Note**: Only applicable if this is a Australian Government project (central gov, devolved administrations, Services Australia, local authorities, blue light services)
...
**Cost Model**:
- **Setup**: Free OR $AUD [X] one-time
- **Usage**: Free OR [pricing model]
- **Transaction Fees**: [If applicable, e.g., government payment services 1.5%]

**Cost Breakdown**:
| Cost Item | Year 1 | Year 2 | Year 3 | Notes |
|-----------|--------|--------|--------|-------|
| Platform Usage | $AUD [X] | $AUD [Y] | $AUD [Z] | [Free or pricing] |
| Integration | $AUD [W] | $AUD 0 | $AUD 0 | [X] person-weeks |
| **Total** | **$AUD [T1]** | **$AUD [T2]** | **$AUD [T3]** | |
| **3-Year TCO** | | | **$AUD [TOTAL]** | Significantly lower than commercial |

**Pros**:
- ✅ Free or subsidized for public sector
- ✅ Privacy Act 1988 compliant, Australian data residency
- ✅ Meets Government Service Standard
- ✅ Well-documented, supported by DTA
- ✅ DTA Digital Service Standard compliant (use common platforms)
...
**Digital Service Standard and ICT policies Alignment**:
- ✅ **Point 8**: Share, reuse and collaborate (common platform)
- ✅ **Point 6**: Make things secure (security by design)
- ✅ **Point 7**: Make privacy integral (Privacy Act 1988 by design)
...
**Recommended Approach**: [BUILD | BUY: Vendor X | ADOPT: Open Source Y | gov.au Platform Z]
...
|----------|-------------------|--------|--------|--------|------------|
| [Category 1] | [Build/Buy/Adopt] | $AUD [X] | $AUD [Y] | $AUD [Z] | $AUD [TOTAL] |
| [Category 2] | [Build/Buy/Adopt] | $AUD [X] | $AUD [Y] | $AUD [Z] | $AUD [TOTAL] |
| [Category 3] | [Build/Buy/Adopt] | $AUD [X] | $AUD [Y] | $AUD [Z] | $AUD [TOTAL] |
| [Category 4] | [Build/Buy/Adopt] | $AUD [X] | $AUD [Y] | $AUD [Z] | $AUD [TOTAL] |
| **TOTAL** | | **$AUD [X]** | **$AUD [Y]** | **$AUD [Z]** | **$AUD [TOTAL]** |
...
- Engineering rates: $AUD [X]/day (blended rate for contractors/FTE)
- Infrastructure: AWS Australian region pricing (on-demand, reserved instances for savings)
...
|----------|----------|-------------|-------------------|--------------|
| Build Everything | $AUD [X] | +20% | $AUD [Y] | Scope creep, delays, skill gaps |
| Buy (SaaS) | $AUD [X] | +10% | $AUD [Y] | Price increases, vendor changes |
| Open Source | $AUD [X] | +15% | $AUD [Y] | Underestimated maintenance |
| Recommended | $AUD [X] | +12% | $AUD [Y] | Blended risk profile |
...
Assessment against 13 DTA Digital Service Standard points relevant to technology selection:

| DTA Digital Service Standard Point | Status | Notes |
|-----------|--------|-------|
...
| **7. Make privacy integral** | ✅ Compliant | Privacy Act 1988 compliance mandatory, Australian data residency |
| **8. Share, reuse and collaborate** | ✅ Compliant | gov.au platforms used where available |
...
| **13. Spend controls** | ⚠️ If >$AUD 100K | Spend approval process required |

### gov.au Common Platforms Used

| Platform | Category | Status | Rationale |
|----------|----------|--------|-----------|
| gov.au One Login | Authentication | ✅ Recommended | Mandatory for public-facing services |
| government payment services | Payments | ✅ Recommended | No setup fees, 1.5% transaction fee |
| GovNotify | Notifications | ✅ Recommended | Free for central government |
| gov.au Forms | Forms | ✅ Recommended | Free form builder |
| gov.au Publishing | Content | ⚠️ If applicable | For gov.au domain content |

**Benefits of gov.au Platforms**:
- ✅ Free or subsidized for public sector
- ✅ Pre-built, well-tested, accessible
- ✅ Privacy Act 1988 compliant, Australian data residency
- ✅ Meets Service Standard and DTA Digital Service Standard
- ✅ Reduces development and operational costs

### Digital Marketplace Procurement Strategy

**Digital Marketplace 14** (Cloud hosting, software, support):
- [X] suppliers found for [category]
- Top suppliers: [List with day rates or pricing]

**Digital Marketplace (DOS)**:
...
4. Award directly (if <$AUD 100K) or mini-competition (if >$AUD 100K)
...
- ✅ Australian regions preferred but not required
...
- ⚠️ Australian data residency may be required by department policy
...
- [Public cloud (AWS Australian region) | Government Cloud | Air-gapped]
...
- [Insight 3]: [e.g., "Authentication is product - use Auth0 or gov.au One Login"]
...
- NPV: $AUD [Y] (if benefits quantified)
...
- NPV: $AUD [W] (if benefits quantified)
...
- NPV: $AUD [B] (if benefits quantified)
...
- NPV: $AUD [D] (if benefits quantified)
...
- Development: $AUD [X]
- Setup/Integration: $AUD [Y]
- Infrastructure: $AUD [Z]
- **Total CAPEX**: $AUD [TOTAL]

**OPEX (Ongoing Annual)**:
- Subscriptions: $AUD [X]/year
- Infrastructure: $AUD [Y]/year
- Maintenance: $AUD [Z]/year
- Support: $AUD [W]/year
- **Total OPEX**: $AUD [TOTAL]/year

### Benefits for SOBC

**Quantified Benefits** (from vendor claims, case studies, benchmarks):

- **Cost Savings**: $AUD [X]/year from [automation, efficiency, reduction in manual work]
- **Revenue Increase**: $AUD [Y]/year from [improved conversion, new features, faster delivery]
- **Productivity**: [Z] hours/week saved per user × [W] users × $AUD [rate]/hour = $AUD [A]/year
- **Quality**: [Reduce defects by X%, reduce downtime by Y hours/year = $AUD [B] saved]
...
**Total Benefits (3-year)**: $AUD [TOTAL]

**Net Present Value (NPV)**: $AUD [Benefits - Costs discounted at 7% real per Department of Finance guidance]
...
- **Mitigation**:
  - Training budget allocated ($AUD [X])
...
**CR-1: Data Residency**
- **Risk**: Vendor doesn't support Australian data residency (required for Privacy Act 1988, Australian Gov)
- **Impact**: HIGH - Compliance blocker
- **Likelihood**: LOW (most major vendors support Australian/APAC regions)
- **Mitigation**:
  - Confirm Australian data residency in contract
...
3. **Budget Approval**: Secure budget for [$AUD X] over 3 years
...
- Security and compliance (ISO 27001, SOC 2, Privacy Act 1988)
...
- **DTA Digital Service Standard**: Digital Service Standard and ICT policies (Australian Government)
