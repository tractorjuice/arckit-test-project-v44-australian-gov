...
## 13. Australian Government AI Compliance
...
|-----------|--------------|---------|
| Training compute | [$AUD X] | [Per job] |
| Serving infrastructure | [$AUD X] | [Per request] |
| Storage | [$AUD X] | [Per GB] |
| Monitoring tools | [$AUD X] | [Fixed] |
| **Total** | **[$AUD X]** | - |
