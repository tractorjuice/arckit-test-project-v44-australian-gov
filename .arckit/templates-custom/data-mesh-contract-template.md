...
|--------|------------------|-----------|------------------|
| {Object 1} | {7 years} | {Legal requirement: ATO tax records} | {Automated deletion via lifecycle policy} |
...
### 6.4 Privacy Act 1988 / Privacy Act 1988 and Australian Privacy Principles Compliance
...
| **Cross-Border Transfers** | {Data stored in Australia (Sydney region), no transfers outside Australia} |
...
4. **Compliance**: {Comply with your own Privacy Act 1988 obligations if handling PII}
...
|-------------------|-----------|-------------------|
| {API Requests} | {$AUD 0.001 per 1000 requests} | {Monthly} |
| {Data Transfer} | {$AUD 0.05 per GB} | {Monthly} |
| {Storage} | {$AUD 0.02 per GB per month} | {Monthly} |
| {Premium Support} | {$AUD 500 per month} | {Monthly} |
...
- **DR Region**: {Australia (Melbourne) - ap-southeast-4}
...
- Australian Government Data Quality Framework: https://www.gov.au/government/publications/the-government-data-quality-framework
- National Data Strategy: https://www.gov.au/government/publications/uk-national-data-strategy
