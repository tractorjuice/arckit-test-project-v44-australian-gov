...
**Budget**: $AUD [amount]
**Team**: [X FTE average]
**Delivery Model**: DTA Agile Delivery (Discovery → Alpha → Beta → Live)
...
|-------|----------|-----------|----------------|----------------|-------|
| Discovery | [X] weeks | $AUD [X] | $AUD [X] | $AUD [X] | $AUD [X] |
| Alpha | [Y-X] weeks | $AUD [X] | $AUD [X] | $AUD [X] | $AUD [X] |
| Beta | [Z-Y] weeks | $AUD [X] | $AUD [X] | $AUD [X] | $AUD [X] |
| Live (Year 1) | 12 months | $AUD [X] | $AUD [X] | $AUD [X] | $AUD [X] |
| **Total** | | | | | **$AUD [TOTAL]** |
