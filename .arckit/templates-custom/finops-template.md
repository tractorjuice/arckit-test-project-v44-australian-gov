...
| Unit Economics | [$AUD X per transaction/user] | [Scale costs with value] |
...
|----------|---------------------|---------|---------------|
| [AWS / Azure / GCP] | [Account ID/Name] | [Production / Dev / Shared] | [$AUD X,XXX] |

### Cost Centers

| Cost Center | Description | Monthly Budget | Current Spend |
|-------------|-------------|----------------|---------------|
| [CC-001] | [Production workloads] | [$AUD X,XXX] | [$AUD X,XXX] |
| [CC-002] | [Development/Test] | [$AUD X,XXX] | [$AUD X,XXX] |
| [CC-003] | [Shared services] | [$AUD X,XXX] | [$AUD X,XXX] |
...
| Compute | [$AUD X,XXX] | [X%] |
| Storage | [$AUD X,XXX] | [X%] |
| Networking | [$AUD X,XXX] | [X%] |
| Database | [$AUD X,XXX] | [X%] |
| Other services | [$AUD X,XXX] | [X%] |
| **Total** | **[$AUD X,XXX]** | **100%** |
...
|---------|--------|----------|----------|
| Q1 | [$AUD XX,XXX] | [$AUD XX,XXX] | [±X%] |
| Q2 | [$AUD XX,XXX] | [$AUD XX,XXX] | [±X%] |
| Q3 | [$AUD XX,XXX] | [$AUD XX,XXX] | [±X%] |
| Q4 | [$AUD XX,XXX] | [$AUD XX,XXX] | [±X%] |
| **Total** | **[$AUD XXX,XXX]** | **[$AUD XXX,XXX]** | **[±X%]** |
...
|--------|-------------|--------|
| Cost per user | Total cost / Active users | [$AUD X.XX] |
| Cost per transaction | Total cost / Transactions | [$AUD X.XX] |
| Cost per API call | Compute cost / API calls | [$AUD X.XX] |
...
|------|----------|-------------------|--------|-------------|
| [RI/SP] | [AWS/Azure/GCP] | [$AUD X,XXX] | [Date] | [X%] |

### Commitment Coverage

| Service | On-Demand Spend | Committed | Coverage |
|---------|-----------------|-----------|----------|
| Compute | [$AUD X,XXX] | [$AUD X,XXX] | [X%] |
| Database | [$AUD X,XXX] | [$AUD X,XXX] | [X%] |
| **Total** | **[$AUD X,XXX]** | **[$AUD X,XXX]** | **[X%]** |

### Purchase Recommendations

| Recommendation | Savings | Term | Break-even |
|----------------|---------|------|------------|
| [Compute SP $AUD X,XXX] | [$AUD X,XXX/year] | [1yr/3yr] | [X months] |
| [RDS RI instance-type] | [$AUD X,XXX/year] | [1yr] | [X months] |
...
|-------------|-------------------|
| <$AUD 1,000/month | Team lead |
| $AUD 1,000-$AUD 10,000/month | Engineering manager |
| $AUD 10,000-$AUD 50,000/month | FinOps lead + Finance |
| >$AUD 50,000/month | Leadership approval |
...
### Department of Finance Spend Controls

| Control | Threshold | Requirement |
|---------|-----------|-------------|
| Digital spend | >$AUD 100k | Department of Finance approval |
| Technology spend | >$AUD 100k | Department of Finance approval |
| External hosting | Any | Justify vs Digital Marketplace |

### Department of Finance Business Case Alignment

| Aspect | Implementation |
|--------|----------------|
| Business case | Cloud costs in options analysis (per Department of Finance guidance) |
| Value for money | Unit economics tracked per Commonwealth Procurement Rules |
| Risk assessment | Cost overrun scenarios modeled per AS/NZS ISO 31000 |
| Benefits realization | Cost savings tracked vs baseline |

### Digital Marketplace / Digital Marketplace Tracking

| Metric | Current | Target |
|--------|---------|--------|
| Digital Marketplace spend | [$AUD X,XXX] | [Track separately] |
| Marketplace spend | [$AUD X,XXX] | [Track separately] |
| SME percentage | [X%] | [>33%] |
...
|--------|-----------|-----------|
| Annual technology spend | Annual | Department of Finance |
| Transparency data | Annual | Public |
| Digital Marketplace spend | Quarterly | whole-of-government procurement panels |
...
| Metric | Current | Target | Trend |
|--------|---------|--------|-------|
| Cost per user | [$AUD X.XX] | [$AUD X.XX] | [↑/↓/→] |
| Cost per transaction | [$AUD X.XX] | [$AUD X.XX] | [↑/↓/→] |
...
|------------|----------------|--------|
| Rightsizing | [$AUD X,XXX/year] | [X%] complete |
| Commitment purchases | [$AUD X,XXX/year] | [X%] complete |
| Idle resource cleanup | [$AUD X,XXX/year] | [X%] complete |
| Storage optimization | [$AUD X,XXX/year] | [X%] complete |
| **Total** | **[$AUD XX,XXX/year]** | - |
...
|----------------|-------------|----------------|--------|
| [BR-XXX] | [Budget constraint $AUD X] | Budget management | ✅ |
