...
| **Investment Horizon** | [N] years, $AUD [AMOUNT] total investment |
...
**Investment**: $AUD [AMOUNT] over [N] years ([%]% of total)
...
|-------|----------|-------|------------|------------------|
| Foundation | FY [YEAR] Q[N]-Q[N] | Establish baseline, strategy | $AUD [AMOUNT] | Principles, governance, assessment |
| Transformation | FY [YEAR]-FY [YEAR] | Deliver strategic themes | $AUD [AMOUNT] | Themes 1-4 capabilities |
| Optimisation | FY [YEAR] Q[N]-Q[N] | Realise benefits, optimise | $AUD [AMOUNT] | KPIs met, continuous improvement |
...
|----------|--------|------------|
| **Capital Expenditure (CAPEX)** | $AUD [AMOUNT] | [%]% |
| **Operational Expenditure (OPEX)** | $AUD [AMOUNT] | [%]% |
| **Total Investment** | **$AUD [AMOUNT]** | **100%** |

### Investment by Financial Year

| Financial Year | CAPEX ($AUD ) | OPEX ($AUD ) | Total ($AUD ) | % of Budget |
|----------------|-----------|----------|-----------|-------------|
...
| Theme | Investment ($AUD ) | % of Total | Expected Benefit |
|-------|----------------|------------|------------------|
...
| Metric | Value |
|--------|-------|
| **Net Present Value (NPV)** | $AUD [AMOUNT] |
...
|------------------|-----------|-------------|-------------|-------------|-------|
| Cost Savings | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [TOTAL] |
| Cost Avoidance | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [AMOUNT] | $AUD [TOTAL] |
...
**Constraints**:
1. [Constraint 1, e.g., "Budget capped at $AUD [AMOUNT]"]
